...
public class DeleteWorkspaceTransportAction
    extends HandledTransportAction<DeleteWorkspaceRequest, DeleteWorkspaceResponse> {
  private final WorkspaceIndexService service;

  @Inject
  public DeleteWorkspaceTransportAction(
  ...
  protected void doExecute(
      Task task, DeleteWorkspaceRequest request, ActionListener<DeleteWorkspaceResponse> listener) {
