...
public class UpdateWorkspaceResponse extends ActionResponse implements ToXContentObject {
    ...
    public UpdateWorkspaceResponse(Workspace workspace) { this.workspace = workspace; }
    public UpdateWorkspaceResponse(StreamInput in) throws IOException { super(in); workspace = new Workspace(in); }
