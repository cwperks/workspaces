...
public class GetWorkspaceRequest extends ActionRequest {
    ...
    public GetWorkspaceRequest(String workspaceId) { this.workspaceId = workspaceId; }
    public GetWorkspaceRequest(StreamInput in) throws IOException { super(in); workspaceId = in.readString(); }
